...
class WriteToJsonTest {
    ...
    private static final String TEST_FILE_PATH = "files/busesDatabase.jsonl";  // изменён путь
    ...
    void shouldWriteBusesToJsonlFile() throws Exception {
        ...
        Files.createDirectories(testFilePath.getParent());  // создаст папку files, если её нет
    ...
    void shouldNotFailOnEmptyList() throws Exception {
        ...
        List<String> lines = Files.readAllLines(testFilePath);
        // пустой список не добавляет строк, но файл остаётся существовать
    }
}